...
def create_keyspace(session):
    ...
    print("Keyspace create successfully")
...
def insert_data(session, **kwargs):
    ...
    try:
        session.execute("""
                        INSERT INTO spark_streams.create_users(id, first_name, last_name, gender,
...
def create_cassandra_connection():
    ...
    try:
        ...
        logging.error(f"Could not create cassandra due to {e}")
        return None
